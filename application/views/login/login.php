      ...
      <div class="content-wrapper d-flex align-items-center auth auth-bg-1 theme-one">
        <div class="row w-100">
          ...
          <div class="col-lg-4 mx-auto">
              <center><h3 style="color: white;">SISTEM INFORMASI PERMINTAAN BELI BARANG (SIMPBB)</h3></center>
...
<!--
                <div class="form-group">
                  <button class="btn btn-block g-login">
                    <img class="mr-3" src="<?php echo base_url('assets_s/images/file-icons/icon-google.svg');?>" alt="">Log in with Google</button>
                </div>
...
-->
            ...
            <p class="footer-text text-center">copyright © 2019 | Fasilkom-TI</p>
          </div>
        </div>
      </div>

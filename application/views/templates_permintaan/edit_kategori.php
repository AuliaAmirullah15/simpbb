            ...
            <div class="col-lg-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <?php 
                     ...
                     <form class="forms-sample" method="post" action="<?php echo base_url('Permintaan/update_kategori/'. $id_kategori) ; ?>">
                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Nama Kategori</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="exampleInputEmail2" placeholder="Nama Kategori" name="nama_kategori" value="<?= $nama_kategori ?>">
                          </div>
                        </div>
                        
                        <div class="form-group row">
                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Rp</label>
                          <div class="col-sm-9">
                            <input type="number" class="form-control" id="exampleInputEmail2" placeholder="Biaya" name="biaya" value="<?= $biaya ?>">
                          </div>
                        </div>
